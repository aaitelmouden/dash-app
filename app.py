...
app.layout = html.Div(children=[
    html.H2(children='Interactive Visualizations in Python | Tree Health in NYC'),
    html.P(children='This App will be looking at the New York City tree census. The data was provided by a volunteer driven census in 2015'),
    html.H4(children='Select Tree Species'),
    ...
    html.H4(children='Select Bborough'),
